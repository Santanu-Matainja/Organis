...
class OrdersSellerExportController extends Controller
{
    ...
    public function OrdersExcelExport(Request $request){
		...
		$spreadsheet -> getActiveSheet()				
					...
					// ->SetCellValue('G4', __('Commission').'('.$gtext['currency_icon'].')')							
		...
		$spreadsheet -> getActiveSheet()->getStyle('G4') -> applyFromArray(array('font' => array('size' => '12', 'bold' => true)), 'H4');
		$spreadsheet -> getActiveSheet()->getStyle('H4') -> applyFromArray(array('font' => array('size' => '12', 'bold' => true)), 'I4');
		$spreadsheet -> getActiveSheet()->getStyle('I4') -> applyFromArray(array('font' => array('size' => '12', 'bold' => true)), 'J4');
		$spreadsheet -> getActiveSheet()->getStyle('J4') -> applyFromArray(array('font' => array('size' => '12', 'bold' => true)), 'K4');
		$spreadsheet -> getActiveSheet()->getStyle('K4') -> applyFromArray(array('font' => array('size' => '12', 'bold' => true)), 'L4');
		...
		foreach($datalist as $row){
			...
			$total_amount = $row->total_amount+$shipping_fee+$row->tax;
    ...
    public function OrdersCSVExport(Request $request){
		...
		$spreadsheet -> getActiveSheet()				
					...
					->SetCellValue('E4', __('Subtotal').'('.$gtext['currency_icon'].')')							
					->SetCellValue('F4', __('Tax').'('.$gtext['currency_icon'].')')							
					// ->SetCellValue('F4', __('Commission').'('.$gtext['currency_icon'].')')							
					->SetCellValue('G4', __('Shipping Fee').'('.$gtext['currency_icon'].')')							
					->SetCellValue('H4', __('Total Amount').'('.$gtext['currency_icon'].')')
					->SetCellValue('I4', __('Payment Method'))
					->SetCellValue('J4', __('Payment Status'))
