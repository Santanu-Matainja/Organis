...
class OrdersController extends Controller
{
    ...
    public function getOrdersPageLoad() {
        ...
        return view('backend.orders', compact('order_status_list', 'datalist', 'commissions'));		
	}
    ...
    public function getOrderData($id) {
        ...
        return view('backend.order', compact('payment_status_list', 'order_status_list', 'mdata', 'datalist', 'commissions'));		
	}	
