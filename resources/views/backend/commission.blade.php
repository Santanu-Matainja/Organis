					...
					<div class="card-body">
						<form novalidate="" data-validate="parsley" id="DataEntry_formId">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="commission">{{ __('Commission €') }} <span class="red">*</span></label>
										<input type="number" value="{{ $datalist['commission'] }}" name="commission" id="commission" class="form-control parsley-validated" data-required="true">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
...
@push('scripts')
<!-- css/js -->
<script src="{{asset_path('backend/pages/commission.js')}}"></script>
@endpush