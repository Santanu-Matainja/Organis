	...
	<table class="table table-borderless table-theme" style="width:100%;">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-left"><a href="{{ route('backend.Adminorder', [$row->master_order_no]) }}">{{ $row->master_order_no }}</a></td>
				...
				<td class="text-center">
					<div class="btn-group action-group">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="{{ route('backend.Adminorder', [$row->master_order_no]) }}">{{ __('View') }}</a>
							<a class="dropdown-item" href="{{ route('frontend.order-invoice', $row->master_order_no) }}">{{ __('Invoice') }}</a>
