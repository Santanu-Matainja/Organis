						...
						<div class="tabs-body">
							...
							<div class="row">
								<div class="col-lg-3 mb-30">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset_path('backend/images/home-1.jpg')}}" />
										</div>
								...
								<div class="col-lg-3 mb-30">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset_path('backend/images/home-2.jpg')}}" />
										</div>
										<div class="theme-footer">
								...
								<div class="col-lg-3 mb-30">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset_path('backend/images/home-3.jpg')}}" />
										</div>
										<div class="theme-footer">
								...
								<div class="col-lg-3 mb-30">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset_path('backend/images/home-4.jpg')}}" />
										</div>
										<div class="theme-footer">
							...
							<div class="row mb-30">
								<div class="col-lg-2">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset_path('backend/images/full_width.jpg')}}" />
										</div>
										<div class="theme-footer">
								...
								<div class="col-lg-2">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset_path('backend/images/left_sidebar.jpg')}}" />
										</div>
										<div class="theme-footer">
								...
								<div class="col-lg-2">
									<div class="theme-view-card">
										<div class="theme-image">
											<img src="{{asset_path('backend/images/right_sidebar.jpg')}}" />
										</div>
										<div class="theme-footer">
...
<script src="{{asset_path('backend/pages/page_variation.js')}}"></script>
@endpush