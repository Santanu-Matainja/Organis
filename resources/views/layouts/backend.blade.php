...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link rel="stylesheet" href="{{asset_path('backend/css/chosen/bootstrap-chosen.min.css')}}">
    <link rel="stylesheet" href="{{asset_path('backend/css/jquery.gritter.min.css')}}">
  ...
  <body>
	...
	<script src="{{asset_path('backend/js/jquery-ui.min.js')}}"></script>
	<script src="{{asset_path('backend/js/jquery.nicescroll.min.js')}}"></script>
	<script src="{{asset_path('backend/js/parsley.min.js')}}"></script>
	<script src="{{asset_path('backend/js/chosen.jquery.min.js')}}"></script>
	<script src="{{asset_path('backend/js/jquery.popupoverlay.min.js')}}"></script>
	<script src="{{asset_path('backend/js/jquery.gritter.min.js')}}"></script>
