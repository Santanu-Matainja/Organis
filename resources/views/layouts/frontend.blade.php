...
<head>
	...
	@else
	<link href="{{asset_path('frontend/css/bootstrap.min.css')}}" rel="stylesheet">
	@endif
	<link href="{{asset_path('frontend/css/bootstrap-icons.css')}}" rel="stylesheet">
	<link href="{{asset_path('frontend/css/owl.carousel.min.css')}}" rel="stylesheet">
	<link href="{{asset_path('frontend/css/magnific-popup.css')}}" rel="stylesheet">
	<link href="{{asset_path('frontend/css/jquery-ui.min.css')}}" rel="stylesheet">
	<link href="{{asset_path('frontend/css/slick.css')}}" rel="stylesheet">
	<link href="{{asset_path('frontend/css/jquery.gritter.min.css')}}" rel="stylesheet">
	...
	<link href="{{asset_path('frontend/css/style.css')}}" rel="stylesheet">
	<link href="{{asset_path('frontend/css/responsive.css')}}" rel="stylesheet">
	@stack('style')
	@if($gtext['custom_css'] != '')
	<style type="text/css">
...
<body {!! $gtext['is_rtl'] == 1 ? 'class="rtl"' : '' !!}>
	...
	<!-- js -->
	<script src="{{ asset_path('frontend/js/jquery-3.6.0.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/popper.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/bootstrap.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/owl.carousel.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/jquery.countdown.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/scrolltop.js') }}"></script>
	<script src="{{ asset_path('frontend/js/jquery-ui.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/jquery.magnific-popup.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/slick.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/jquery.popupoverlay.min.js') }}"></script>
	<script src="{{ asset_path('frontend/js/jquery.gritter.min.js') }}"></script>
	<script>
	...
	<script src="{{ asset_path('frontend/js/scripts.js')}}"></script>
	<script src="{{asset_path('frontend/pages/cart.js')}}"></script>
	<script>
		$(function () {
