...
<section class="footer-top" style="background-image: url({{ asset_path('media/'.$gtext['subscribe_background_image']) }});">
	<div class="container">
		<div class="row">
...
<footer class="footer-section" style="background-image: url({{ $FooterSection->image ? asset_path('media/'.$FooterSection->image) : '' }});">
					...
					<div class="footer-widget-card">
						...
						<div class="footer-widget mb25">
							<div class="info-card">
								...
								<div class="info-logo">
									<img src="{{ asset_path('media/'.$gtext['about_logo_footer']) }}" alt="" />
								</div>
								@endif
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="payment-method">
						...
						<img src="{{ asset_path('media/'.$gtext['payment_gateway_icon']) }}" />
						@endif
					</div>
					@endif
				</div>
