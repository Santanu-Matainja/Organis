...
@section('meta-content')
	...
	<meta property="og:image" content="{{ $data->og_image ? asset_path('media/'.$data->og_image) : asset_path('media/'.$data->thumbnail) }}" />
	...
	<meta name="twitter:image" content="{{ $data->og_image ? asset_path('media/'.$data->og_image) : asset_path('media/'.$data->thumbnail) }}">
@endsection
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-details">
						<div class="blog-img">
							<img src="{{ asset_path('media/'.$data->thumbnail) }}" alt="{{ $data->title }}" />
						</div>
