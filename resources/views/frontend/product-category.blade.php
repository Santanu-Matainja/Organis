...
@section('meta-content')
	...
	<meta property="og:image" content="{{ asset_path('media/'.$metadata['og_image']) }}" />
	...
	<meta name="twitter:image" content="{{ asset_path('media/'.$metadata['og_image']) }}">
@endsection
...
<script src="{{asset_path('frontend/pages/product-category.js')}}"></script>
@endpush	