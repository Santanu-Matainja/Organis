...
function onPaginationDataLoad(page) {
	...
	$.ajax({
		url:base_url + "/backend/getAdminOrdersTableData?page="+page+"&status="+status+"&start_date="+start_date+"&end_date="+end_date,
...
function onRefreshData() {
	...
	$.ajax({
		url:base_url + "/backend/getAdminOrdersTableData?status="+status,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/backend/getAdminOrdersTableData?search="+search+"&status="+status,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onFilterAction() {
	...
	$.ajax({
		url: base_url + "/backend/getAdminOrdersTableData?start_date="+start_date+"&end_date="+end_date,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/AdminbulkActionOrders',
